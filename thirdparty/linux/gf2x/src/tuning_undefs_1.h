...
#ifndef TUNING_UNDEFS_1_H_
#define TUNING_UNDEFS_1_H_
 ...
 * gf2x/gf2x_mul1.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_1.h  is not included again.
 */
#undef  GF2X_MUL1_H_
 ...
 * another function for doing mul1
 */


#define gf2x_mul1               tuning_gf2x_mul1
#undef  GF2X_FUNC
