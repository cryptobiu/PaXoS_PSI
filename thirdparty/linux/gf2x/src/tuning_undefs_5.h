...
#ifndef TUNING_UNDEFS_5_H_
#define TUNING_UNDEFS_5_H_
 ...
 * gf2x/gf2x_mul5.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_5.h  is not included again.
 */
#undef  GF2X_MUL5_H_
 ...
 * another function for doing mul5
 */


#define gf2x_mul5               tuning_gf2x_mul5
#undef  GF2X_FUNC
#define GF2X_FUNC(x)    tuning_ ## x
#undef  GF2X_STORAGE_CLASS_mul5
#define GF2X_STORAGE_CLASS_mul5 /**/
