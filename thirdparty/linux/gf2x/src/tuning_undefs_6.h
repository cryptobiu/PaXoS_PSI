...
#ifndef TUNING_UNDEFS_6_H_
#define TUNING_UNDEFS_6_H_
 ...
 * gf2x/gf2x_mul6.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_6.h  is not included again.
 */
#undef  GF2X_MUL6_H_
 ...
 * another function for doing mul6
 */


#define gf2x_mul6               tuning_gf2x_mul6
#undef  GF2X_FUNC
#define GF2X_FUNC(x)    tuning_ ## x
#undef  GF2X_STORAGE_CLASS_mul6
#define GF2X_STORAGE_CLASS_mul6 /**/
