...
#ifndef TUNING_UNDEFS_8_H_
#define TUNING_UNDEFS_8_H_
 ...
 * gf2x/gf2x_mul8.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_8.h  is not included again.
 */
#undef  GF2X_MUL8_H_
 ...
 * another function for doing mul8
 */


#define gf2x_mul8               tuning_gf2x_mul8
#undef  GF2X_FUNC
#define GF2X_FUNC(x)    tuning_ ## x
#undef  GF2X_STORAGE_CLASS_mul8
#define GF2X_STORAGE_CLASS_mul8 /**/
