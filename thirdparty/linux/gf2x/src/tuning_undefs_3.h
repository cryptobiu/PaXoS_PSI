...
#ifndef TUNING_UNDEFS_3_H_
#define TUNING_UNDEFS_3_H_
 ...
 * gf2x/gf2x_mul3.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_3.h  is not included again.
 */
#undef  GF2X_MUL3_H_
 ...
 * another function for doing mul3
 */


#define gf2x_mul3               tuning_gf2x_mul3
#undef  GF2X_FUNC
