...
#ifndef TUNING_UNDEFS_9_H_
#define TUNING_UNDEFS_9_H_
 ...
 * gf2x/gf2x_mul9.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_9.h  is not included again.
 */
#undef  GF2X_MUL9_H_
 ...
 * another function for doing mul9
 */


#define gf2x_mul9               tuning_gf2x_mul9
#undef  GF2X_FUNC
#define GF2X_FUNC(x)    tuning_ ## x
#undef  GF2X_STORAGE_CLASS_mul9
#define GF2X_STORAGE_CLASS_mul9 /**/
