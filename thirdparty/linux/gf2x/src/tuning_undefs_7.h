...
#ifndef TUNING_UNDEFS_7_H_
#define TUNING_UNDEFS_7_H_
 ...
 * gf2x/gf2x_mul7.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_7.h  is not included again.
 */
#undef  GF2X_MUL7_H_
 ...
 * another function for doing mul7
 */


#define gf2x_mul7               tuning_gf2x_mul7
#undef  GF2X_FUNC
#define GF2X_FUNC(x)    tuning_ ## x
#undef  GF2X_STORAGE_CLASS_mul7
#define GF2X_STORAGE_CLASS_mul7 /**/
