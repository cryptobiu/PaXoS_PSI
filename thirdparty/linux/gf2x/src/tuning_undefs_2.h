...
#ifndef TUNING_UNDEFS_2_H_
#define TUNING_UNDEFS_2_H_
 ...
 * gf2x/gf2x_mul2.h, the file _is_ read due to the fact that we
 * undefine the protection flag below. However this file
 * tuning_undefs_2.h  is not included again.
 */
#undef  GF2X_MUL2_H_
 ...
 * another function for doing mul2
 */


#define gf2x_mul2               tuning_gf2x_mul2
#undef  GF2X_FUNC
